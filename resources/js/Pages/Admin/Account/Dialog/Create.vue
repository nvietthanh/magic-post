    ...
    >
        ...
        <div class="overflow-scroll">
            <el-form ref="form" :model="formData" :rules="rules" label-position="top">
                ...
                <el-form-item label="Phân quyền" class="w-[200px]" prop="role"
                    :error="getError('role')" :inline-message="hasError('role')">
                    <el-select v-model="formData.role" class="w-full" placeholder="Chọn phân quyền">
                        <el-option 
                            v-for="item in rolesHas" 
                ...
                <el-form-item label="Mật khẩu" class="w-[70%]" prop="password"
...
export default {
    ...
    data: function () {
        return {
            ...
            rules: {
                ...
                role: { required: true, message: 'Trường này là bắt buộc', trigger: ['change'] },
    ...
    created() {
        this.rolesHas = this.getRoleHasCreate()
    },
    methods: {
        open(data) {
        ...
        prepareForSubmit() {
            ...
            return {
                action: this.formData?.id
                    ? route('admin.api.account.update', this.formData?.id)
                    : route('admin.api.account.store'),
