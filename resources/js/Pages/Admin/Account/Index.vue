    ...
    <AppLayout>
        <template v-slot:main>
            <div class="flex h-[56px] items-center w-full px-2 bg-[white] border-b-[2px]">
                <h1 class="bold text-[20px] font-bold">Danh sách tài khoản admin</h1>
...
export default {
    ...
    data: function () {
        return {
            ...
            fields: [
                ...
                { key: 'role', label: 'Phân quyền', width: 170, align: 'left', headerAlign: 'left' },
    ...
    methods: {
        fetchData() {
            ...
            axios.get(route('admin.api.account.index', this.filter))
                .then(({ data }) => {
