<template>
    ...
    >
        ...
        <div>
            ...
            <div>
                <div class="flex justify-between">
                    <span class="font-bold">Xác nhận đơn hàng đến điểm tập kết đích:</span>
                </div>
...
import { TRANSIT_TO_CONCENTRATE_DESTINATION_RECEIVE } from '@/Store/Consts/oderStatus'
    ...
    methods: {
        async open(data) {
            ...
            for (let item of this.formData.status) {
                if (item.type == TRANSIT_TO_CONCENTRATE_DESTINATION_RECEIVE) {
        ...
        changeStatus() {
            ...
            axios.get(route('admin.api.concentrate-order-receive.change-concentrate-des-receive', params))
                .then(({ data }) => {
